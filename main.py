...
"""
### 명령어
python main.py --mode 'train' --batch_size 8 --dir_data 'datasets' --name_data 'monet2photo'  --dir_checkpoint 'checkpoint' --dir_log 'log' --dir_result 'result' --gpu_ids '1,2'
...
parser.add_argument('--name_data', type=str, default='monet2photo', dest='name_data')  # TODO: 데이터셋에 따라 다르게
...
parser.add_argument('--wgt_i', type=float, default=5e-1, dest='wgt_i') # TODO: 데이터셋마다 weight 다르게
